...
import { Credits, FooterContainer, SocialIconLink, SocialIcons, SocialLogo, SocialMedia, SocialMediaWrap, WebsiteRights } from './FooterElements'

const Footer = () => {

	const preventDragHandler = event => event.preventDefault()
